...
const SmartBinApplication = () => {
    ...
    const fetchBills = async () => {
        try {
            ...
            if (data?.success || data?.succeeded) {
                ...
                const newBills = responseData.map((item) => ({
                    billId: item.billId,
    ...
    const filteredApplications = useMemo(() => {
        ...
        return result;
    }, [applications, searchQuery, statusFilter, serviceFilter, startDateFilter, endDateFilter]);
    ...
    const exportData = () => {
        ...
        try {
            ...
            exportToCSV(exportRows, "corporate_bills");
    ...
    const paymentOptions = [
        { id: 'Alat By Wema', text: 'Pay by card/bank/transfer', icon: AlatIcon },
    ];
