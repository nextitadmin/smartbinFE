                                    ...
                                    <div className="flex p-6 rounded-2xl min-h-[230px] w-full bg-[linear-gradient(288.72deg,rgba(0,120,54,0.75)_0%,#007836_98.68%)]">
                                        <div className="w-full">
                                            ...
                                            <div className="flex items-center w-full justify-between mt-2">
                                                <h2 className="text-white text-3xl font-sans mt-1">
                                                    {showBalance ? (walletBalance || '₦0') : '₦ ****'}
                                                </h2>
                                                <button
                                                    type="button"
                                                    onClick={() => setShowBalance(prev => !prev)}
                                                    className="text-white opacity-75 hover:opacity-100 transition-opacity focus:outline-none cursor-pointer mr-8 mt-1"
